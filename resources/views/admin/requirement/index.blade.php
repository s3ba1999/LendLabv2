...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
            <h3 class="text-dark mb-0" style="font-weight: bold;">Prestamos</h3>
        </div>
            ...
            <div class="col" style="width: 736.2px;">
                <div class="table-responsive" style="margin: 0px;margin-bottom: 18px;">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($requierements as $key => $requierement)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td>{{$requierement->recibe}}</td>
                                    <td>{{$requierement->delivered}}</td>
                                    <td>{{$requierement->created_at}}</td>
                                    <td>{{$requierement->state}}</td>
                                    {{-- <td>
